...
namespace Model
{
    ...
    public class GeneratorRandomPersons
    {
            ...
            Adult partner = null, Gender gender = Gender.Default)
        {
            ...
            // Работа.
            string[] job = { "НПО «Алмаз»", "Тульский оружейный завод",
                "ЛМЗ им. К. Либкнехта", "Кировский завод «Маяк»",
                "Красмаш", "Концерн «Калашников»" };
        ...
        public static Child GetRandomChild()
        {
            ...
            string[] kindergarten = {
                "Дестсад «Люблю работать»", "Дестсад «У станка»",
                "Дестсад «Ребенок по ГОСТу»", "Дестсад «Труд»",
                "Дестсад «Рожден для работы»", "Дестсад «За ВДВ»",
                "Дестсад «Авангард»", "Дестсад «Тополь-М»"};
